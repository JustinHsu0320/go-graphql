...
func main() {
	fmt.Println("GraphQL Start!")
	tutorials := populate()

	var commentType = graphql.NewObject(
		graphql.ObjectConfig{
			Name: "Comment",
			// we define the name and the fields of our object.
			// In this case, we have one solitary field that is of type string.
	...
	fields := graphql.Fields{
		"tutorial": &graphql.Field{
			...
			// We can define `arguments that allow us to pick specific tutorials`.
			// In this case we want to be able to `specify the ID` of the tutorial we want to retrieve
